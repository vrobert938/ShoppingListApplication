    ...
    fun openDialog(){
        ...
        addbtn.setOnClickListener {
            ...
            if (itemname.isNotEmpty() && itemprice.isNotEmpty() && itemquantity.isNotEmpty()){
                ...
                Toast.makeText(applicationContext,"Elem hozzáadva", Toast.LENGTH_SHORT).show()
                groceryRVAdapter.notifyDataSetChanged()
                dialog.dismiss()
            }
            else{
                Toast.makeText(applicationContext,"Kérlek mindent tölts ki!", Toast.LENGTH_SHORT).show()
            }
        }
        dialog.show()
    }
